/**
 * 通用配置属性
 * Created by yelingfeng on 2016/8/15.
 */
 ...
 * 通用字体
 */
export const commonFontFamily = 'Microsoft YaHei';

/**
 *y轴分割线颜色
 */
export const yAxisSplitColor = 'rgba(0,228,255,0.1)';

/**
 * 图例颜色
 */
export const legendColor = "#00d8f1";
 ...
 * 横向柱图颜色集合
 */
export const barColorList = ["#8000ff", "#6f00ff", "#4c00ff", "#0000ff", "#0040ff", "#0055ff", "#006aff", "#0080ff",
